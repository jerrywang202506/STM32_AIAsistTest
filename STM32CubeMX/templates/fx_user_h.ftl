...
[#assign FX_STANDALONE_ENABLE_VAL = "0"]
[#assign TX_ENABLED_VAL = "false"]
[#assign FX_ENABLED_VAL = "false"]
[#if RTEdatas??]
[#list RTEdatas as define]
[#if define?contains("THREADX_ENABLED")]
[#assign TX_ENABLED_VAL = "true"]
[/#if]
[#if define?contains("FILEX_ENABLED")]
[#assign FX_ENABLED_VAL = "true"]
[/#if]
[/#list]
[/#if]

[#if TX_ENABLED_VAL == "false" && FX_ENABLED_VAL == "true"]
[#assign FX_STANDALONE_ENABLE_VAL = "1"]
[/#if]

[#-- Standalone mode support is dropped for now, --]
[#-- following line to be remove once support is restored --]
[#assign  FX_STANDALONE_ENABLE_VAL = "0"]
