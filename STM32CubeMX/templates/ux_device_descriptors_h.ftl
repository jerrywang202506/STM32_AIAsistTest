...
[#if RTEdatas??]
[#list RTEdatas as defs]
  [#if defs?contains("UX_DEVICE_STORAGE")]
#define USBD_MSC_CLASS_ACTIVATED                       1U
  [/#if]
  [#if defs?contains("UX_DEVICE_HID")]
#define USBD_HID_CLASS_ACTIVATED                       1U
  [/#if]
  [#if defs?contains("UX_DEVICE_CDC_ACM")]
#define USBD_CDC_ACM_CLASS_ACTIVATED                   1U
  [/#if]
  [#if defs?contains("UX_DEVICE_CDC_ECM")]
#define USBD_CDC_ECM_CLASS_ACTIVATED                   1U
  [/#if]
  [#if defs?contains("UX_DEVICE_DFU")]
...
[#if define?contains("UX_DEVICE_HID")]
...
[#if define?contains("UX_DEVICE_CDC_ACM") || define?contains("UX_DEVICE_CDC_ECM")]
[#if acm_ecm_rndis == "0"]
...
[#if define?contains("UX_DEVICE_CDC_ECM")]
...
[#if define?contains("UX_DEVICE_DFU")]
...
[#if RTEdatas??]
[#list RTEdatas as define]
[#if define?contains("UX_DEVICE_STORAGE")]
...
[#if define?contains("UX_DEVICE_CDC_ACM")]
