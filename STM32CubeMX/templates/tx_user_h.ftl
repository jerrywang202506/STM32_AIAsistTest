...
[#if SWIP.defines??]
  [#list SWIP.defines as definition]
    ...
    [#if name == "TX_NO_TIMER"]
      [#assign TX_NO_TIMER_value = value]
    [/#if]
...
[#if (TX_THREAD_GET_SYSTEM_STATE_value == "_tx_thread_system_state") || (TX_THREAD_GET_SYSTEM_STATE_value == " ") || (TX_THREAD_GET_SYSTEM_STATE_value == "")]
