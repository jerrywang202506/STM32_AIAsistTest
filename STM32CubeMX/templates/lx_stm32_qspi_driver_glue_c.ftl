...
[#assign  glue_api = "HAL_API_POLLING"]
...
[#if SWIP.defines??]
  [#list SWIP.defines as definition]
    ...
    [#if name == "LX_QSPI_GLUE_FUNCTION_IMPLEMENTATION"]
...
/* HAL Polling based implementation for QuadSPI component ${qspi_comp}
...
[#if glue_api == "HAL_API_POLLING"]
  ...
  /* Set S# timing for Read command: Min 20ns for ${qspi_comp} memory */
