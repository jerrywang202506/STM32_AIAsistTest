...
[#assign NX_CLOUD_COMPONENT_ENABLED = "false"]

[#if RTEdatas??]
[#list RTEdatas as define]
[#if define?contains("NX_CLOUD_ENABLED")]
[#assign NX_CLOUD_COMPONENT_ENABLED = "true"]
[/#if]
[/#list]
[/#if]
[#compress]
...
[#if NX_DISABLE_PACKET_CHAIN_value == "true" || NX_DISABLE_FRAGMENTATION_value == "true"]
