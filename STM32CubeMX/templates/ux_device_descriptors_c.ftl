...
[#if SWIP.defines??]
  ...
  [#list RTEdatas as define]
    ...
    [#if define?contains("UX_DEVICE_HID") || define?contains("UX_DEVICE_STORAGE") || define?contains("UX_DEVICE_CDC_ACM") || define?contains("UX_DEVICE_CDC_ECM") || define?contains("UX_DEVICE_DFU")]
